...
- Crear un archivo HTML llamado **index.html**
- Incluir la etiqueta <html>
...
- input tipo texto, radio, numero, email, password, checkbox y submit (agregar atributo size=40 a los campos de texto. Separe con p cada grupo.)
